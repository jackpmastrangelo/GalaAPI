...
public class TicketService {
  ...
  /*
    ...
    2. No ambiguity about datasources
    3. The AwsS3Service would then fully display the scope of S3 at the business level
    4. Consolidate S3-dependant constants like the bucket name and key
    5. Closer to the code that retrieves the QR-code and could add clarity to the lifecycle of the QR code
   */
